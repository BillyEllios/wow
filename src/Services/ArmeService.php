...
class ArmeService {
    public  const N_ARME = ['Arc','Arbalète','Arme de Jet','Arme de Pugilat','Arme à Feu','Armes d\'Hast','Baguette','Bâton','Epée à une main','Epée à deux mains','Masse à une main','Masse à deux mains'];
